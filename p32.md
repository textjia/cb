...
<body>
    <a href="{{ link.image }}" target="right-top" onClick="window.parent.frames['right-bottom'].location='{{ link.url }}';"><img src="{{ link.image }}" width="32" height="32" title="{{ link.title }}"></a>
</body>
</html>
